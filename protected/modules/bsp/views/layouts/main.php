                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                         ...
                         <li><?php echo CHtml::link('каталог',array('/site/page','view'=>'prods')); ?></li>
                         <li><?php echo CHtml::link('о нас',array('/site/page','view'=>'about')); ?></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <?php echo CHtml::link('Paysys<b class="caret"></b>','#',array('class'=>'dropdown-toggle','data-toggle'=>'dropdown')); ?>
                        <ul class="dropdown-menu">
                        <li><?php echo CHtml::link('описание',array('/bsp','id'=>'slider')); ?></li>
                        <li><?php echo CHtml::link('детально',array('/bsp','id'=>'slider_1')); ?></li>
                        <li><?php echo CHtml::link('документы',array('/bsp','id'=>'slider_2')); ?></li>
                     <li class="divider"></li>
                        <li><?php echo CHtml::link('каталог продуктов',array('/bsp')); ?></li>
