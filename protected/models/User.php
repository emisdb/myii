...
class User extends MARC
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('username, email, password, name', 'length', 'max'=>255),
			...
			array('id, username, email, password, last_login_time, name, create_time, update_time, update_user_id, create_user_id', 'safe', 'on'=>'search'),
		);
	}
