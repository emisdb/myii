...
public static function getAllowedStatusRange()
	...
	public function rules()
	{
		...
		return array(
			array('name', 'required'),
			array('project_id, type_id, status_id, owner_id, requester_id, create_user_id, update_user_id, issue_id', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>255),
			array('description', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, description, project_id, type_id, status_id, owner_id, requester_id, issue_id, create_time, update_time, update_user_id, create_user_id', 'safe', 'on'=>'search'),
	...
	public function relations()
	{
		...
		return array(
			...
			'issues' => array(self::HAS_MANY, 'Issue', 'issue_id'),
